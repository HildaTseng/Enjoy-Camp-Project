          ...
          <div class="col-xl-10">
            ...
            <div class="my-10 d-none d-md-block">
              ...
              <div class="border border-g-40">
                ...
                <div>
                  <ul
                    class="row text-center py-5 align-items-center m-0"
                    v-for="cart in carts"
                    :key="cart.id"
                  >
                ...
                <div class="border-top border-g-40">
                  <ul
                    class="row text-center py-4 gy-4 align-items-center border-bottom m-0"
                    v-if="total - final_total"
                  >
                    <li class="col-10 text-end m-0">優惠券折抵</li>
                    <li class="col-2 text-danger text-end pe-lg-20 m-0">
                  ...
                  >
                    ...
                    <li class="col-2 text-end pe-lg-20 m-0">
                      $ {{ toCurrency(total) }}
                    </li>
                  </ul>
                  <ul
                  ...
                  >
                    ...
                    <li class="col-2 fw-bold fs-19 text-end pe-lg-20 m-0">
              ...
              <div class="my-5 container">
                ...
                <div>
                  <ul
                    ...
                    :key="cart.id"
                  >
                    <li class="col-8 p-0 text-start ps-3">
                      {{ cart.product.title }}
                    </li>
                    <li class="col-4 p-0">
                      $ {{ toCurrency(cart.product.price) }}
                ...
                <div class="border-top border-primary">
                  ...
                  >
                    ...
                    <li class="col-5 text-danger text-end px-6">
                      - ${{ toCurrency(total - final_total) }}
                    </li>
                  </ul>
                  <ul
                  ...
                  >
                    ...
                    <li class="col-5 fw-bold fs-19 text-end px-6">
                      $ {{ toCurrency(final_total) }}
                    </li>
                  </ul>
                </div>
            ...
            <div class="mt-12 my-10">
              ...
              <div class="border-rwd-0">
                <ul
                  class="row text-center py-5 align-items-center justify-content-center border-bottom m-0"
                >
                ...
                >
                  ...
                  <li class="col-xl-4 col-md-5 col-9">
                    {{ form.user.address }}
                  </li>
                </ul>
                <ul
            ...
            <div class="d-flex flex-row justify-content-center mb-10">
              <button
                type="button"
                class="btn btn-primary rounded-0 px-12 py-2 position-relative"
                @click="createOrder"
              >
                送出訂單
              </button>
