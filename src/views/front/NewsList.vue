  ...
  <main>
    <section>
      ...
      <div class="container">
        ...
        <div
          class="my-10 d-flex flex-column justify-content-center align-items-center"
        >
          <h2
            class="fs-28-rwd-19 fw-bold px-5 border-primary border-2 border-start border-end d-inline mb-10"
          >
            最新消息
          </h2>
          <div class="row gy-5 w-100">
            <div
              class="col-md-6 col-xl-4 card-group"
              ...
              <div class="card rounded-0">
                ...
                <div class="card-body">
                  <router-link
                    ...
                    class="hover-opacity"
                  >
                    <h3 class="card-title fs-6 fw-bold my-4">
                      {{ article.title }}
                    </h3>
                  </router-link>
                  <p
