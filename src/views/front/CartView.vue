        ...
        <div class="row justify-content-center">
          <div class="col-xl-10">
            ...
            <div class="my-10 d-none d-md-block">
              ...
              <div class="border border-g-40">
                ...
                <div v-if="carts.length > 0">
                  <ul
                    class="row text-center py-5 align-items-center border-bottom m-0"
                    v-for="cart in carts"
                    :key="cart.id"
                  >
                    ...
                    <li class="col-2">
                      ...
                      >
                        <option :value="i" v-for="i in 20" :key="`${i}12`">
                          {{ i }}
                        </option>
                      </select>
                    </li>
                    <li class="col-2 p-0">
                      $ {{ toCurrency(cart.product.price) }}
                    </li>
                    <li class="col-2">$ {{ toCurrency(cart.total) }}</li>
                    <li class="col-1">
                      <button
                        type="button"
                        class="border-0 bg-white hover-text-primary"
                        @click="deleteCartItem(cart)"
                        :disabled="cart.id === loadingItem"
                      >
                        <i class="fa-regular fa-trash-can fs-19"></i>
                      </button>
                    </li>
                  </ul>
                </div>
                ...
                <ul
                  class="row text-end py-5 fs-19 bg-secondary align-items-center justify-content-between m-0"
                >
                ...
                <ul
                  class="row text-center py-4 align-items-center border-bottom m-0"
                  v-if="total - final_total"
                >
                  <li class="col-9 text-end">優惠券折抵</li>
                  <li class="col-3 text-danger text-end">
                    - ${{ toCurrency(total - final_total) }}
                  </li>
                </ul>
                <ul
                  class="row text-center py-4 align-items-center border-bottom m-0"
                ...
                >
                  ...
                  <li class="col-3 fw-bold fs-19 text-end">
              ...
              <div class="d-flex flex-row justify-content-end mt-5">
                <router-link to="/from" v-if="carts.length > 0">
                  <button
                    type="button"
                    class="btn btn-primary rounded-0 px-12 py-2 position-relative hvr-icon-wobble-horizontal"
                  >
                    結帳去
                    <span
                      class="material-icons align-middle icon-right p-0 hvr-icon"
                    >
                      trending_flat
                    </span>
                  </button>
            ...
            <div class="mt-5 mb-10 d-block d-md-none container">
              ...
              <div v-if="carts.length > 0">
                <ul
                  class="row text-center py-4 gy-4 align-items-center border-bottom"
                  v-for="cart in carts"
                  :key="cart.id"
                >
                  <li class="col-7 p-0 text-start ps-3">
                    {{ cart.product.title }}
                  </li>
                  <li class="col-3 p-0 text-end">
                    $ {{ toCurrency(cart.product.price) }}
                  </li>
                  <li class="col-2 p-0">
                    <button
                      ...
                      :disabled="cart.id === loadingItem"
                    >
                      <i class="fa-regular fa-trash-can fs-7 text-primary"></i>
                    </button>
                  </li>
                  <li class="col-6">
                    <select
                  ...
                  <li class="col-6 d-flex flex-row justify-content-around">
                    小計<span class="fw-bold"
                      >$ {{ toCurrency(cart.total) }}</span
                    >
                  </li>
                </ul>
              </div>
              ...
              <ul
                class="row text-center py-5 fs-19 bg-secondary align-items-center"
              >
              ...
              >
                ...
                <li class="col-5 text-danger text-end">
                  - ${{ toCurrency(total - final_total) }}
                </li>
              </ul>
              <ul
              ...
              >
                ...
                <li class="col-5 fw-bold fs-19 text-end">
                  $ {{ toCurrency(final_total) }}
                </li>
              </ul>
              <div class="d-flex flex-row mt-5">
                <router-link
                  ...
                  >結帳去
                  <span class="material-icons align-middle icon-right p-0">
                    trending_flat
                  </span></router-link
                >
              </div>
