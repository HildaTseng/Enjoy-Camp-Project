      ...
      <div class="container my-lg-12 my-10">
        ...
        <div class="row">
            ...
            <div class="accordion accordion-flush" id="accordionLarge">
              <div class="accordion-item border-bottom">
                <h3 class="accordion-header">
                  <button
                    class="btn px-5 pt-0 pb-4 w-100 text-start border-0"
                    type="button"
                    @click="getProducts"
                  >
                    全部商品
                    ...
                    <ul class="ps-4">
                      <li class="p-3">
                        <button
                          ...
                          @click="getCategoryCampModeProducts('家庭露營')"
                        >
                          家庭露營系列
                        </button>
                      </li>
                      <li class="p-3">
                        <button
                          type="button"
                          class="border-0 bg-transparent p-0"
                          @click="getCategoryCampModeProducts('機車露營')"
                        >
                          機車露營系列
                        </button>
                      </li>
                      <li class="p-3">
                        <button
                          type="button"
                          class="border-0 bg-transparent p-0"
                          @click="getCategoryCampModeProducts('登山露營')"
                        >
                          登山露營系列
                        </button>
                      </li>
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button
                    class="btn py-4 px-5 w-100 text-start border-0"
                    type="button"
          ...
          <div class="col-lg-9">
            <!-- title & 排序 -->
            <div
              class="d-lg-flex flex-lg-row justify-content-lg-between align-items-center mb-10"
            >
              <h2 class="px-5 mb-5 border-primary border-2 border-start fs-5">
                {{ title }}
              </h2>

              <select
                class="form-select rounded-0 w-auto"
                @change="changeSelect"
              >
                ...
                <div class="card rounded-0">
                  <router-link :to="`/product/${product.id}`">
                    <div class="position-relative">
                      ...
                      />
                      <div
                        class="btn-hover-add-cart d-flex justify-content-center align-items-center"
                      >
                        <button
                          type="button"
                          class="add-cart-btn"
                    ...
                    <div
                      class="card-body py-5 px-3 text-center border-0 d-flex flex-column"
                    >
                      <h4 class="card-title fs-19 fw-bold mb-auto">
                        {{ product.title }}
                      </h4>
