...
<template>
  ...
  <header :class="headerClass" ref="header">
    <div class="container d-flex justify-content-between align-items-center py-5">
      <h1>
        <router-link to="/" class="header-logo" :class="h1Class">享露</router-link>
      </h1>
      <ul class="nav d-md-flex justify-content-end align-items-center d-md-block d-none w-100" :class="ulClass">
        <li>
          <router-link to="/about" :class="liClass">關於我們</router-link>
        </li>
        <li>
          <router-link to="/products" :class="liClass" class="mx-10">商品分類</router-link>
        </li>
        <li>
          <router-link to="/news" :class="liClass" class="me-10">最新消息</router-link>
        </li>
      </ul>
      <router-link to="/cart" :class="cartClass"
        class="px-4 pt-4 pb-3 rounded-circle d-md-block d-none position-relative">
        <span class="material-symbols-outlined fs-16">shopping_cart</span>
        <span class="badge rounded-pill bg-danger position-absolute top-0 start-100 translate-middle-x"
          v-if="carts?.length > 0">{{ carts.length }}</span>
      </router-link>

      <!-- RWD 漢堡選單 -->
      <nav class="d-md-none d-block d-flex align-items-center">
        <button class="btn btn-white d-flex align-items-center" type="button" data-bs-toggle="offcanvas"
  ...
  <!-- RWD選單  -->
  <div ref="offcanvas" class="offcanvas offcanvas-start d-md-none d-block border-0 overflow-auto vh-100" tabindex="-1"
    id="offcanvasStart" aria-labelledby="offcanvasStartLabel" data-bs-scroll="true" data-bs-backdrop="false">
    <div class="vh-100">
      ...
      <div class="offcanvas-body py-0 d-flex flex-column justify-content-between" style="height: calc(100vh - 80px)">
        <ul class="fw-bold fs-6">
          <li class="py-5 border-bottom border-secondary fs-5">
            <router-link to="/about" class="ps-5">關於我們</router-link>
          </li>
            ...
            <div class="accordion accordion-flush" id="accordionTitle">
              <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingTitle">
                  <button class="accordion-button collapsed fs-5 fw-bold bg-white ps-5 w-50 border-0" type="button"
                    data-bs-toggle="collapse" data-bs-target="#flush-collapseTitle" aria-expanded="false"
                    aria-controls="flush-collapseTitle">
                    商品分類
                  </button>
                </h2>
                <div id="flush-collapseTitle" class="accordion-collapse collapse" aria-labelledby="flush-headingTitle"
                  ...
                  <div class="accordion-body py-0" style="width: 60%">
                    <div class="accordion accordion-flush" id="accordionSmall">
                      ...
                      <div class="accordion-item border-0">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                          ...
                          <div class="accordion-body py-2 px-0">
                            <ul class="ps-4">
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                              ...
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('登山露營')">
                                  登山露營系列
                                </button>
                              </li>
                            </ul>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                          ...
                          <div class="accordion-body py-2 px-0">
                            <ul class="ps-4">
                              ...
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('天幕')">
                                  天幕
                                </button>
                              </li>
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('帳篷配件')">
                                  帳篷配件
                                </button>
                              </li>
                            </ul>
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                          ...
                          <div class="accordion-body py-2 px-0">
                            <ul class="ps-4">
                              ...
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('睡袋')">
                                  睡袋
                                </button>
                              </li>
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('床墊')">
                                  床墊
                                </button>
                              </li>
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('枕頭')">
                                  枕頭
                                </button>
                              </li>
                            </ul>
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                          ...
                          <div class="accordion-body py-2 px-0">
                            <ul class="ps-4">
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('燈具')">
                                  燈具
                                </button>
                              </li>
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('煤油燈')">
                                  煤油燈
                                </button>
                              </li>
                            </ul>
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                          ...
                          <div class="accordion-body py-2 px-0">
                            <ul class="ps-4">
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('爐具')">
                                  爐具
                                </button>
                              </li>
                              <li class="px-5">
                                <button type="button" class="text-primary border-0 p-0 bg-transparent fs-16 fw-normal"
                                  @click="getCategoryProducts('餐具')">
                                  餐具
                                </button>
                              </li>
                            </ul>
                      ...
                      <div class="accordion-item border-0">
                        <h3 class="accordion-header">
                          <button class="btn py-3 px-5 w-100 text-start border-0" type="button"
                            @click="getCategoryProducts('保冷/水箱')">
                            保冷/水箱
                          </button>
                        </h3>
                      </div>
                      <div class="accordion-item border-0">
                        <h3 class="accordion-header">
                          <button class="btn py-3 px-5 w-100 text-start border-0" type="button"
                            @click="getCategoryProducts('收納/配件')">
                            收納/配件
                          </button>
                        </h3>
                      </div>
          ...
          <li class="py-5 border-bottom border-secondary fs-5">
            <router-link to="/news" class="ps-5">最新消息</router-link>
          </li>
          <li class="py-5 border-bottom border-secondary fs-5">
            <router-link to="/cart" class="ps-5">購物車</router-link>
          </li>
        </ul>
        ...
        <div class="ps-5 py-5">
          <ul class="d-flex">
            <li>
              <a href="#"><img src="@/assets/image/icon/ic_twotone-facebook.png" alt="facebook" /></a>
            </li>
            <li class="mx-3">
              <a href="#"><img src="@/assets/image/icon/ph_instagram-logo-fill.png" alt="instagram" /></a>
            </li>
            <li>
              <a href="#"><img src="@/assets/image/icon/mdi_facebook-messenger.png" alt="messenge" /></a>
            </li>
          </ul>
  ...
  <footer>
    <div class="container d-md-flex justify-content-between py-md-12 py-10 border-top border-g-40">
      ...
      <div class="d-flex flex-md-row flex-column">
        ...
        <ul class="ps-lg-12 my-10 my-md-0 border-md-start order-1 order-md-2">
          ...
          <li class="my-md-8 my-3">
            <router-link to="/products"> - 商品分類</router-link>
          </li>
    ...
    <div class="bg-primary">
      <p class="text-center text-white fs-9 py-5 fw-bold">
        此網站僅作品展示使用，無商業用途。
      </p>
    </div>
  </footer>
